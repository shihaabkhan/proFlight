...
const HomePage = () => {
  ...
  const weatherForecast = [
    { city: 'Miami', temp: '84°F', condition: 'Sunny', icon: <Sun size={20} className="text-yellow-500" /> },
    { city: 'New York', temp: '72°F', condition: 'Partly cloudy', icon: <Sun size={20} className="text-gray-500" /> },
    { city: 'Los Angeles', temp: '76°F', condition: 'Clear', icon: <Sun size={20} className="text-yellow-500" /> },
    { city: 'Chicago', temp: '68°F', condition: 'Windy', icon: <Wind size={20} className="text-blue-500" /> },
    { city: 'Orlando', temp: '82°F', condition: 'Rain showers', icon: <Umbrella size={20} className="text-blue-500" /> },
  ]
