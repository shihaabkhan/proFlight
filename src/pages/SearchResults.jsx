    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-md">
        <div className="container mx-auto px-4 py-3">
          ...
          >
            <div>
              <p className="text-sm text-gray-600">New York (JFK) ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Los Angeles (LAX)</p>
              <p className="text-xs text-gray-500">Jun 15, 2023 ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ 1 Passenger ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ Economy</p>
            </div>
            <div>
