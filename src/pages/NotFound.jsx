        ...
        <div className="max-w-lg mx-auto text-center">
          ...
          <div className="mt-10 border-t border-gray-200 pt-8 text-sm">
            ...
            <ul className="text-gray-600 space-y-2">
              <li>ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¢ Checking the URL for typos</li>
              <li>ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¢ Going back to the previous page</li>
              <li>ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¢ Starting fresh from our homepage</li>
              <li>ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¢ Using the search function above</li>
            </ul>
          </div>
        </div>
      </div>
