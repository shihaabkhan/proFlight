              ...
              <div className="p-6">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Flight {flightStatus.flightNumber} ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ {flightStatus.aircraft}</p>
                  </div>
                </div>
