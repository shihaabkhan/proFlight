            ...
            <div className="mt-4">
              ...
              {flight.layovers && flight.layovers.map((layover, index) => (
                <div key={index} className="flex items-center text-sm mb-2">
                  ...
                  <span>
                    {layover.airport} ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ {formatDuration(layover.durationMinutes)} layover
                  </span>
                </div>
              ))}
            </div>
